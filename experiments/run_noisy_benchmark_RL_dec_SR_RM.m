% Run the decentralized benchmark through the route-observation noise path.
...
% The evaluation runner loads agents_mat before calling this script.
agent1 = agents_mat.agent1;
agent2 = agents_mat.agent2;
agent3 = agents_mat.agent3;
...
for i=1:N
    ...
    % Each agent retunes its local controller once per RL interval.
    if mod(k_c,param_RL_low.M_RL) == 0
        ...
        if k < (180+60)
            ...
            agentObs1 = agentObs1.*x1_noise;
        end

        tic
        rl_params1 = getAction(agent1,agentObs1);
        rl_params1 = rl_params1{1}.*param_RL_low.action_scales(1:2);

        rl_params2 = getAction(agent2,agentObs2);
        rl_params2 = rl_params2{1}.*param_RL_low.action_scales(3:5);

        rl_params3 = getAction(agent3,agentObs3);
        rl_params3 = rl_params3{1}.*param_RL_low.action_scales(6:8);

        params_dta.KP = rl_params1(1);
        params_dta.KI = rl_params1(2);
        params_alinea_1.KP = rl_params2(1);
        params_alinea_1.KI = rl_params2(2);
        params_alinea_1.rho_c = rl_params2(3);
        params_alinea_2.KP = rl_params3(1);
        params_alinea_2.KI = rl_params3(2);
        params_alinea_2.rho_c = rl_params3(3);
    ...
    param_hist(:,i) = [rl_params1;rl_params2;rl_params3];
    k = k+1;
    k_c = k_c + 1;
end
