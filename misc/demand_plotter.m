...
demands = filtfilt(b,a,Demands.o1c1(62:2102)); % + Demands.o1c2(62:2102);
...
demands = filtfilt(b,a,Demands.o2c1(62:2102)); % + Demands.o2c2(62:2102);

plot(t,demands,'Color', "#3BAA32","LineWidth",2)



demands = filtfilt(b,a,Demands.o1c2(62:2102)); % + Demands.o1c2(62:2102);

plot(t,demands,"LineWidth",2)

demands = filtfilt(b,a,Demands.o2c2(62:2102)); % + Demands.o2c2(62:2102);
